# <img src="https://github.com/KilianKegel/pictures/blob/master/New-icon.png"  width="48" height="48">Buildspeed comparison EDK2-UEFI-SHELL tianocoreBuild  vs. Microsoft Visual Studio MSBUILD
...
* [Intention](README.md#intention)<br>
  * [Download](https://github.com/KKKontron/Visual-UEFI-SHELL/tree/main/UEFIBinaries)<br>
...
### Buildspeed comparison EDK2-UEFI-SHELL tianocoreBuild  vs. Microsoft Visual Studio MSBUILD
The **UEFI SHELL** build process is a time-consuming task when using the traditional UEFI/TIANOCORE build process.<br>
When transforming the **UEFI SHELL** build process to **MSBUILD** (Microsoft Visual Studio Build), the build process is significantly faster.<br>
The **MSBUILD** build process is about 4 times faster than the traditional **TIANOCORE** build process.<br>
Additionally Visual Studio provides a modern IDE with **IntelliSense** and **Copilot** support, that iproves the development experience significantly.
...
https://github.com/KKKontron/Visual-UEFI-SHELL/tree/main/UEFIBinaries
